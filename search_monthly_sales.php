...
WHERE MONTH(sale_date)='$sale_month'and YEAR(sale_date)=$year";
...
<table class="responsive-table">
    ...
    $run="SELECT SUM(item_price) FROM tbl_sales where MONTH(sale_date)='$sale_month'";
    ...
    echo "<br>";
    echo "<br>";
    $run="SELECT * FROM tbl_sales where  MONTH(sale_date)='$sale_month'";
    $row=mysqli_query($con,$run);
